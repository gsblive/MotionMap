...
#SVIFile = os.path.abspath(os.path.join(myPath, os.pardir) + "/Contents/Server Plugin/scratch.previousVersionInfo.py") # To make a tmp file of previous version of info (doesnt work)
theTimeString = time.strftime("%m/%d/%Y %I:%M:%S %p")
