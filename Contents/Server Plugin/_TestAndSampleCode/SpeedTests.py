...
def	sortedList():
	for x in range(0,10000):
		...
		delayQueue.append((6,'greg'))
		delayQueue = sorted(delayQueue)
		delayQueue.append((5,'malley'))
		delayQueue = sorted(delayQueue)
		delayQueue.append((1,'greg'))
		delayQueue = sorted(delayQueue)
		delayQueue.append((2,'heather'))
		delayQueue = sorted(delayQueue)
...
def	sortDeq():
	for x in range(0,10000):
		...
		insertDeq(delayQueue,(6,'greg'))
		insertDeq(delayQueue,(5,'malley'))
		insertDeq(delayQueue,(1,'greg'))
		insertDeq(delayQueue,(2,'heather'))
...
cancelDelayedAction(delayQueue, "greg")
print(str(delayQueue))
cancelDelayedAction(delayQueue, "heather")
print(str(delayQueue))
cancelDelayedAction(delayQueue, "chance")
print(str(delayQueue))
cancelDelayedAction(delayQueue, "malley")
print(str(delayQueue))
cancelDelayedAction(delayQueue, "greg")
print(str(delayQueue))
